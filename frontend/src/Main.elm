...
import Html.Events exposing (onInput, onClick) -- Para capturar clics y escritura
import Html.Attributes exposing (placeholder, value) -- Para los inputs
        ...
        Contact ->
            ...
            , div []
                ...
                , button 
                    ...
                    [ text "Enviar Mensaje" ]
                , p [ style "color" "green" ] [ text model.contactStatus ]
                ]
            ]
...
viewContacto model =
    div [ style "padding" "20px" ]
        [ h1 [] [ text "Contacto" ]
        , input [ placeholder "Email", value model.contactEmail, onInput UpdateEmail, style "display" "block" ] []
        , textarea [ placeholder "Mensaje", value model.contactBody, onInput UpdateBody, style "display" "block", style "height" "100px" ] []
        , button [ onClick SendContacto ] [ text "Enviar" ]
        , p [ style "color" "green" ] [ text model.contactStatus ]
        ]
